        ...
        <div class="col-md-6">
            <form action="" method="post">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Berdasarkan Nama..." name="keyword">
        ...
        <div class="col-md-6">
            ...
            <!-- <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <a href="<?= base_url(); ?>menu/detail/<?= $m['id']; ?>"
            ...
            <div class="col-md-4">
              <div class="card" mb-3>
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>menu/hapus/<?= $row['id']; ?>"
                        class="badge badge-danger float-right tombol-hapus">hapus</a>
                    <a href="<?= base_url(); ?>menu/ubah/<?= $row['id']; ?>"
                        class="badge badge-success float-right">ubah</a>
